...
![Screenshot of the Aspire dashboard showing the ginapp container resource built from a Dockerfil](./images/aspire-dashboard-container-build.png)
...
- [An container runtime supported by .NET Aspire, e.g. Docker Desktop or Podman](https://learn.microsoft.com/dotnet/aspire/fundamentals/setup-tooling#container-runtime)
