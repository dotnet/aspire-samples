...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eShopLite.CatalogDb.CatalogBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("eShopLite.CatalogDb.CatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("eShopLite.CatalogDb.CatalogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("eShopLite.CatalogDb.CatalogItem", b =>
                {
                    b.HasOne("eShopLite.CatalogDb.CatalogBrand", "CatalogBrand")
                        .WithMany()
                        .HasForeignKey("CatalogBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eShopLite.CatalogDb.CatalogType", "CatalogType")
                        .WithMany()
